...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="bg-white text-black w-3/4 rounded-md shadow-md px-3 flex flex-row justify-between">
      ...
      <div className="bg-primary text-secondary w-11/12 px-3 py-1 my-5 rounded-md shadow-md">
        <div className="flex flex-col items-center">
          <Image
            priority
            src={profileImg}
            ...
            <ul className="flex flex-col md:grid md:grid-cols-2 md:grid-flow-row px-4 md:items-cente md:justify-between">
              {department.employees.map((employee) => (
                <li key={employee.id} className="">
                  <div className="bg-secondary text-accent1 rounded-md shadow-md m-2 mx-2 px-2 items-center w-34 lg:min-w-80 flex flex-row justify-between md:min-w-60 ">
                    <Image
                      priority
                      src={profileImg}
                      alt="profile image"
